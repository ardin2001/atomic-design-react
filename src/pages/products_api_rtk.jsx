...
import CartsProducts from "../components/fragments/cartsProducts";
import { useDispatch } from "react-redux";
import cartSlice from "../redux/cartSlice";
import Navbar from "../components/fragments/navbar";
import useAuth from "../hooks/useAuth";

const ProductApiRTKPage = () => {
  useAuth('')
      ...
      {loading ? (
        ...
        <div>
          ...
          <div className="flex">
            ...
            <CartsProducts products={products} loading={loading} />
          </div>
        </div>
      )}
    </Fragment>
...
export default ProductApiRTKPage;
